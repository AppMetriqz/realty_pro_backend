...
import { CurrentPendingPaymentDto } from './current-pending-payment.dto';
...
@Table({
  tableName: 'Current_Pending_Payment',
  timestamps: false,
  comment: 'VIEW',
  freezeTableName: true,
})
export class CurrentPendingPaymentView extends Model<CurrentPendingPaymentDto> {
  @PrimaryKey
