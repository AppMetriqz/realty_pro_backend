...
import { CurrentOverduePaymentDto } from './current-overdue-payment.dto';
...
@Table({
  tableName: 'Current_Overdue_Payment',
  timestamps: false,
  comment: 'VIEW',
  freezeTableName: true,
})
export class CurrentOverduePaymentView extends Model<CurrentOverduePaymentDto> {
  @PrimaryKey
